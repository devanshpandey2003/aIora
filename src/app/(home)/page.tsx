...
const Page = () => {
  return (
    <div className="flex flex-col max-w-7xl mx-auto w-full px-4">
      <section className="space-y-12 py-8 md:py-16 lg:py-20">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-5xl font-bold bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent leading-tight mb-6">
            Build Something Amazing with Vibe
          </h1>
          <p className="text-lg md:text-xl lg:text-xl text-muted-foreground/80 max-w-3xl leading-relaxed">
            Create, collaborate, and share your projects effortlessly with the
